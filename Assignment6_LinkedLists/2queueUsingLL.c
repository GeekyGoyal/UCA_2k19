/* C program to Implement a queue (operations - enqueue, dequeue, is_empty,peek) using a Linked List.
*
...
void enqueue(int x) {
    ...
    /* Updating the next field of the specific node as rear points to the address of the last node in the linked list
    *  making the link for the queue So that front can use it to remove element from the queue */
